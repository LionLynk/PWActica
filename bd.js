    ...
    solicitud.onupgradeneeded = function(e) {
        ...
        if (!db.objectStoreNames.contains("solicitudes")) {
            db.createObjectStore("solicitudes", { keyPath: "id", autoIncrement: true });
        }
    };
    ...
    document.getElementById("form").addEventListener("submit", function(e) {
        ...
        const transaccion = db.transaction(["solicitudes"], "readwrite");
        const almacen = transaccion.objectStore("solicitudes");
    ...
    function mostrarDatos(filtro = "") {
        ...
        const transaccion = db.transaction(["solicitudes"], "readonly");
        const almacen = transaccion.objectStore("solicitudes");
    ...
    document.getElementById("buscador").addEventListener("input", function() {
        mostrarDatos(this.value); // Filtrar mientras escribe
    });